...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 17, fontFamily: 'Qomra', flex: 1, textAlign: 'center' },
  ...
  priceCardTitle: { fontSize: 14, fontFamily: 'Qomra', textAlign: 'right' },
  trendRow: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  prevPrice: { fontSize: 12, fontFamily: 'Qomra', textDecorationLine: 'line-through' },
  bigPrice: { fontSize: 28, fontFamily: 'Qomra', textAlign: 'right' },
  newSypPrice: { fontSize: 16, fontFamily: 'Qomra', textAlign: 'right' },
  usdPrice: { fontSize: 15, fontFamily: 'Qomra', textAlign: 'right' },
  ...
  notesTitle: { fontSize: 13, fontFamily: 'Qomra' },
  notesText: { fontSize: 14, fontFamily: 'Qomra', textAlign: 'right', lineHeight: 22 },
  ...
  editBtnText: { fontSize: 16, fontFamily: 'Qomra' },
  notFound: { fontSize: 18, fontFamily: 'Qomra', textAlign: 'center', marginTop: 40 },
  ...
  modalTitle: { fontSize: 20, fontFamily: 'Qomra', textAlign: 'center', marginBottom: 8 },
  modalMessage: { fontSize: 14, fontFamily: 'Qomra', textAlign: 'center', lineHeight: 22, marginBottom: 20 },
  modalBtns: { flexDirection: 'row', gap: 10 },
  modalBtn: { flex: 1, height: 50, borderRadius: 14, alignItems: 'center', justifyContent: 'center', flexDirection: 'row', gap: 6 },
  modalBtnText: { fontSize: 15, fontFamily: 'Qomra' },
});
