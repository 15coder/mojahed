...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 17, fontFamily: 'Qomra', textAlign: 'center', flex: 1 },
  ...
  sectionTitle: { fontSize: 12, fontFamily: 'Qomra', textAlign: 'right', letterSpacing: 0.3 },
  ...
  rateNote: { fontSize: 11, fontFamily: 'Qomra', textAlign: 'right' },
  textarea: { borderRadius: 12, borderWidth: 1, paddingHorizontal: 14, paddingTop: 12, fontSize: 15, fontFamily: 'Qomra', minHeight: 96, textAlignVertical: 'top' },
  ...
  addImageText: { fontSize: 10, fontFamily: 'Qomra' },
  ...
  sheetTitle: { fontSize: 18, fontFamily: 'Qomra', textAlign: 'center', marginBottom: 4 },
  ...
  sourceLabel: { fontSize: 16, fontFamily: 'Qomra', textAlign: 'right' },
  sourceSub: { fontSize: 12, fontFamily: 'Qomra', textAlign: 'right' },
  cancelBtn: { borderRadius: 14, paddingVertical: 14, alignItems: 'center' },
  cancelBtnText: { fontSize: 15, fontFamily: 'Qomra' },
  ...
  modalTitle: { fontSize: 18, fontFamily: 'Qomra', textAlign: 'center', marginBottom: 12 },
