...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 19, fontFamily: 'Qomra', textAlign: 'center' },
  headerCount: { fontSize: 11, fontFamily: 'Qomra', textAlign: 'center' },
  ...
  searchInput: { flex: 1, fontSize: 14, fontFamily: 'Qomra', height: 44 },
  barcodeSearchRow: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  barcodeInput: { flex: 1, height: 44, borderRadius: 12, borderWidth: 1, paddingHorizontal: 12, fontSize: 15, fontFamily: 'Qomra' },
  ...
  emptyTitle: { fontSize: 17, fontFamily: 'Qomra', textAlign: 'center' },
  emptySubtitle: { fontSize: 13, fontFamily: 'Qomra', textAlign: 'center', lineHeight: 20 },
  gridItem: { flex: 1 },
  ...
  sortTitle: { fontSize: 16, fontFamily: 'Qomra' },
  ...
  sortOptionText: { flex: 1, fontSize: 15, fontFamily: 'Qomra', textAlign: 'right' },
  ...
  recentTitle: { fontSize: 12, fontFamily: 'Qomra' },
  ...
  recentName: { fontSize: 12, fontFamily: 'Qomra', textAlign: 'right', lineHeight: 17 },
  recentPrice: { fontSize: 11, fontFamily: 'Qomra', textAlign: 'right' },
  recentPriceNew: { fontSize: 10, fontFamily: 'Qomra', textAlign: 'right' },
