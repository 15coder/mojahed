        ...
        <Pressable style={styles.sheetBackdrop} onPress={() => setActiveModal('none')}>
          <Pressable onPress={() => {}}>
            <SwipeableSheetWrapper
              ...
              handleColor={colors.border}
            >
              <Text style={{ fontSize: 17, fontFamily: 'Qomra', color: colors.foreground, textAlign: 'center', marginBottom: 6 }}>
                نسخة احتياطية
              </Text>
              <Text style={{ fontSize: 12, fontFamily: 'Qomra', color: colors.mutedForeground, textAlign: 'center', marginBottom: 20 }}>
...
const styles = StyleSheet.create({
  ...
  pageTitle: { fontSize: 20, fontFamily: 'Qomra' },
  pageSubtitle: { fontSize: 11, fontFamily: 'Qomra' },
  scroll: { flex: 1 },
  ...
  addProductTitle: { fontSize: 16, fontFamily: 'Qomra' },
  addProductSub: { fontSize: 12, fontFamily: 'Qomra' },
  ...
  sectionTitle: { fontSize: 11, fontFamily: 'Qomra', textAlign: 'right', letterSpacing: 0.4 },
  card: { borderRadius: 16, borderWidth: 1, padding: 14, marginBottom: 2 },
  row: { flexDirection: 'row', alignItems: 'center', gap: 12 },
  rowTitle: { fontSize: 14, fontFamily: 'Qomra', textAlign: 'right' },
  rowSub: { fontSize: 11, fontFamily: 'Qomra', textAlign: 'right' },
  themePreviewDot: { width: 28, height: 28, borderRadius: 14 },
  divider: { height: 1 },
  modeRow: { flexDirection: 'row', alignItems: 'center', gap: 12, paddingVertical: 12 },
  modeLabel: { fontSize: 14, fontFamily: 'Qomra', textAlign: 'right' },
  currencyNote: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 8,
  ...
  currencyNoteText: { flex: 1, fontSize: 11, fontFamily: 'Qomra', textAlign: 'right', lineHeight: 18 },
  label: { fontSize: 12, fontFamily: 'Qomra', textAlign: 'right', lineHeight: 18 },
  rateRow: { flexDirection: 'row', alignItems: 'center', gap: 10 },
  rateInput: { flex: 1, height: 50, borderRadius: 12, borderWidth: 1, paddingHorizontal: 14, fontSize: 18, fontFamily: 'Qomra' },
  ...
  rateNote: { fontSize: 13, fontFamily: 'Qomra', textAlign: 'center' },
  ...
  catName: { fontSize: 14, fontFamily: 'Qomra', textAlign: 'right' },
  catHidden: { fontSize: 10, fontFamily: 'Qomra' },
  ...
  addCatText: { fontSize: 14, fontFamily: 'Qomra' },
  ...
  secActionLabel: { fontSize: 14, fontFamily: 'Qomra', textAlign: 'right' },
  switchLabel: { fontSize: 14, fontFamily: 'Qomra', textAlign: 'right' },
  switchNote: { fontSize: 11, fontFamily: 'Qomra', textAlign: 'right' },
  ...
  backupBannerTitle: { fontSize: 14, fontFamily: 'Qomra', textAlign: 'right' },
  backupBannerSub: { fontSize: 11, fontFamily: 'Qomra', textAlign: 'right', marginTop: 2 },
  backupSummary: {
    flexDirection: 'row', alignItems: 'center',
    borderRadius: 14, borderWidth: 1, paddingVertical: 14,
  },
  backupSummaryItem: { alignItems: 'center', flex: 1 },
  backupSummaryNum: { fontSize: 20, fontFamily: 'Qomra' },
  backupSummaryLabel: { fontSize: 11, fontFamily: 'Qomra', marginTop: 2 },
  ...
  backupRowTitle: { fontSize: 14, fontFamily: 'Qomra', textAlign: 'right' },
  backupRowSub: { fontSize: 11, fontFamily: 'Qomra', textAlign: 'right', marginTop: 2 },
  backupChoiceBtn: {
    flexDirection: 'row', alignItems: 'center', gap: 12,
    borderWidth: 1.5, borderRadius: 16, padding: 14, marginBottom: 10,
  },
  backupChoiceTitle: { fontSize: 13, fontFamily: 'Qomra' },
  backupChoiceSub: { fontSize: 11, fontFamily: 'Qomra', marginTop: 2 },
  ...
  backupCancelText: { fontSize: 14, fontFamily: 'Qomra' },
  infoRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 10 },
  infoValue: { fontSize: 14, fontFamily: 'Qomra' },
  infoLabel: { fontSize: 13, fontFamily: 'Qomra', textAlign: 'right' },
  deleteCatOption: {
    flexDirection: 'row', alignItems: 'center', gap: 10,
    borderWidth: 1.5, borderRadius: 14, padding: 12,
  },
  deleteCatOptionTitle: { fontSize: 13, fontFamily: 'Qomra', textAlign: 'right' },
  deleteCatOptionSub: { fontSize: 11, fontFamily: 'Qomra', textAlign: 'right' },
  autoLockPill: { paddingHorizontal: 14, paddingVertical: 7, borderRadius: 20, borderWidth: 1 },
  autoLockPillText: { fontSize: 13, fontFamily: 'Qomra' },
  ...
  targetCatName: { fontSize: 14, fontFamily: 'Qomra' },
  kavFull: { flex: 1 },
  ...
  modalTitle: { fontSize: 18, fontFamily: 'Qomra', textAlign: 'center', marginBottom: 14 },
  modalLabel: { fontSize: 12, fontFamily: 'Qomra', textAlign: 'right', color: '#888', marginBottom: 4, marginTop: 4 },
  modalInput: { height: 52, borderRadius: 14, borderWidth: 1.5, paddingHorizontal: 14, fontSize: 16, fontFamily: 'Qomra', marginBottom: 2 },
  modalSaveBtn: { height: 52, borderRadius: 14, alignItems: 'center', justifyContent: 'center', marginTop: 8, marginBottom: 4 },
  modalSaveBtnText: { fontSize: 16, fontFamily: 'Qomra' },
  ...
  previewName: { fontSize: 18, fontFamily: 'Qomra' },
  ...
  themeRowText: { fontSize: 15, fontFamily: 'Qomra', textAlign: 'right' },
  ...
  warnText: { flex: 1, fontSize: 13, fontFamily: 'Qomra', textAlign: 'right', lineHeight: 20 },
  ...
  errorText: { flex: 1, fontSize: 13, fontFamily: 'Qomra', textAlign: 'right' },
  ...
  confirmTitle: { fontSize: 19, fontFamily: 'Qomra', textAlign: 'center', marginBottom: 8 },
  confirmMsg: { fontSize: 13, fontFamily: 'Qomra', textAlign: 'center', lineHeight: 20, marginBottom: 16 },
  confirmBtns: { flexDirection: 'row', gap: 10 },
  confirmBtn: { flex: 1, height: 50, borderRadius: 14, alignItems: 'center', justifyContent: 'center' },
  confirmBtnText: { fontSize: 15, fontFamily: 'Qomra' },
});
